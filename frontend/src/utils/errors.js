...
export function getUndoSettleBlockedModal(err) {
  ...
  if (code === 'UNDO_SETTLE_INSUFFICIENT_WALLET' || code === 'UNDO_SETTLE_INSUFFICIENT_ACCOUNT') {
    ...
    return {
      ...
      memberName: d.memberName || 'This member',
      summary: `${accountLine} The returned money was likely paid to a fund provider or withdrawn as manager profit.`,
      rows: [
        d.memberName ? { label: 'Member', value: d.memberName } : null,
        d.ipoName ? { label: 'IPO', value: d.ipoName } : null,
        d.accountLabel ? { label: 'Account', value: d.accountLabel } : null,
