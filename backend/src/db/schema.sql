...
CREATE TABLE IF NOT EXISTS manager_bank_accounts (
  ...
  purpose ENUM('PROVIDER', 'MANAGER') NOT NULL DEFAULT 'PROVIDER',
...
CREATE TABLE IF NOT EXISTS wallet_transactions (
  id INT AUTO_INCREMENT PRIMARY KEY,
  tenant_id INT NOT NULL,
  type ENUM('PROVIDER_IN', 'DISTRIBUTE_OUT', 'RETURN_IN', 'ADJUSTMENT', 'PROVIDER_OUT', 'TRANSFER_OUT', 'TRANSFER_IN', 'PERSONAL_OUT', 'MANAGER_PROFIT_IN') NOT NULL,
  amount DECIMAL(15, 2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS ipo_applications (
  ...
  funding_mode ENUM('DISTRIBUTED', 'THIRD_PARTY_MANDATE') NOT NULL DEFAULT 'DISTRIBUTED',
